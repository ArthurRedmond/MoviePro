...
namespace MoviePro.Controllers
{
    public class MovieCollectionsController : Controller
    {
        ...
        public async Task<IActionResult> Index(int? id)
        {
            ...
            var moviesNotInColletion = await _context.Movie.AsNoTracking().Where(m => movieIdsNotInCollection.Contains(m.Id)).ToListAsync();
            ViewData["IdsNotInCollection"] = new MultiSelectList(moviesNotInColletion, "Id", "Title");
