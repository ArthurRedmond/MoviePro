...
namespace MoviePro.Services
{
    public class TMDBMappingService : IDataMappingService
    {
        ...
        public TMDBMappingService(AppSettings appSettings,
        ...
        public ActorDetail MapActorDetail(ActorDetail actor)
        {
            ...
            if (string.IsNullOrEmpty(actor.birthday))
                ...
                actor.birthday = DateTime.Parse(actor.birthday).ToString("MM dd, yyyy");
            ...
            try
            {
                ...
                crewMembers.ForEach(member =>
                {
                    newMovie.Crew.Add(new MovieCrew()
                    {
                        ...
                        Name = member.name,
                        Job = member.job,
                        ImgUrl = BuildCastImage(member.profile_path)
                    });
                });
